...
/* BOLD PO Fix
        ...
        */
data: window.FormData && this.atcButton && this.atcButton.closest('form') ? new FormData(this.atcButton.closest('form')) : jquery_default.a.param(this.formData),
 contentType: window.FormData && this.atcButton && this.atcButton.closest('form') ? false : 'application/x-www-form-urlencoded; charset=UTF-8',
 processData: false,
dataType: 'json'
      }).done(function (response) {
(typeof window.BOLD !== 'undefined' && typeof window.BOLD.common !== 'undefined' && typeof window.BOLD.common.cartDoctor !== 'undefined' && (response = window.BOLD.common.cartDoctor.fixItem(response)));
...
(typeof window.BOLD !== 'undefined' && typeof window.BOLD.common !== 'undefined' && typeof window.BOLD.common.cartDoctor !== 'undefined' && (secondResponse = window.BOLD.common.cartDoctor.fix(secondResponse)));
